...
<script type="text/javascript" src="<%=request.getContextPath() %>/confmanage/init-currentWeekList.js" defer="defer"></script>
...
<body>
<div class="wrap">
	<h1>当前位置：会议管理&nbsp;&gt;&nbsp;<span class="position_current"> 本周会议安排</span></h1>
		<div id="searchArea" class="search">
			<div id="queryArea" style="display:none">			
			<form name="form1" id="form1" method="post" action="<%=request.getContextPath()%>/conf_searchCurrentWeeks.do">
