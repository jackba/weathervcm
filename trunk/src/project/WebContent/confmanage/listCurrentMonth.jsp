...
<script type="text/javascript" src="<%=request.getContextPath() %>/confmanage/init-currentMonthList.js" defer="defer"></script>
...
<body>
<div class="wrap">
	<h1>当前位置：会议管理&nbsp;&gt;&nbsp;<span class="position_current"> 本月会议安排</span></h1>
		<div id="searchArea" class="search">
			
			<form name="form1" id="form1" method="post" action="<%=request.getContextPath()%>/conf_searchCurrentMonths.do">
