...
<div class="wrap">
<h1>当前位置：基本信息&nbsp;&gt;&nbsp;参会单位&nbsp;&gt;&nbsp;<span class="position_current"> 新增单位</span></h1>
	<div class="search">
	<form id="form1" name="form1" method="post" action="<%=request.getContextPath()%>/unit_save.do">
	<br/>
	<table class="query">
	  <tr class="t_title">
		<th colspan="2" class="t">新增单位</th>
	  </tr>
	  <tr>
	    <th width="20%"><font color="red">&nbsp;*</font>单位名称：</th>
	    <td><label>
	      <input name="unit.unitName" id="unitName" type="text" class="put200" maxlength="80">
	    </label></td>
  	  </tr>
  	  <tr>
	    <th class="row1">终端：</th>
	  ...
	  <tr>
	    <th class="row1">描述：</th>
	    <td class="row2"><label>
	      <textarea name="unit.description" cols="40" rows="5" id="description" class="w600" style="width: 450px;"></textarea>
	    </label></td>
	  </tr>
  </table>
