...
<h1>当前位置：个人信息管理&nbsp;&gt;&nbsp;虚拟房间设置&nbsp;&gt;&nbsp;<span class="position_current"> 新增虚拟房间</span></h1>
	...
	<table class="query">
	  ...
	  <tr>
	    ...
	    <td class="row2"><label>
	      <input name="room.password" type="password" id="password" class="put200" maxlength="8">
	    </label></td>
	  </tr>
	  <tr>
	    <th  class="row1">控制口令：</th>
	    <td class="row2"><label>
	      <input name="room.controlPin" type="password" id="controlPin" class="put200" maxlength="8">
	    </label></td>
	  </tr>
	  <tr>
	    <th class="row1">描述：</th>
				...
				if(resp.success == true){	
					Ext.Msg.alert('成功',resp.msg, function(button){
						if(button == 'ok'){
							...
							window.parent.closeAndRefreshPanel('roomAdd');
						}
					});
				} else {
