...
<script type="text/javascript" src="<%=request.getContextPath() %>/dwr/interface/roomService.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/virtualroom/init-roomList.js" defer="defer"></script>
