...
<title><s:if test="#request.recurrence=='true'">修改预约例会</s:if><s:else>修改预约会议</s:else></title></title>
...
<div class="wrap">
<h1>当前位置：会议管理&nbsp;&gt;&nbsp;会议预约管理&nbsp;&gt;&nbsp;<span class="position_current"><s:if test="#request.recurrence=='true'">修改预约例会</s:if><s:else>修改预约会议</s:else></span></h1>
	<div class="search">
	<s:if test="#request.recurrence=='true'">
	<form id="form1" name="form1" method="post" action="<%=request.getContextPath()%>/conf_updateRecurrence.do">
	<input type="hidden" name="recurrence.recurrenceId" value="<s:property value='recurrence.recurrenceId'/>"/>
	<input type="hidden" name="recurrence.radRecurrenceId" value="<s:property value='recurrence.radConferenceId'/>"/>
	</s:if>
	<s:else>
	...
	<table class="query">
	  <tr class="t_title">
		<th colspan="2" class="t"><s:if test="#request.recurrence=='true'">修改预约例会</s:if><s:else>修改预约会议</s:else></th>
	  </tr>
	  <tr>
