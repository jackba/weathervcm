...
<script type="text/javascript" src="<%=request.getContextPath() %>/dwr/interface/serviceService.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/service/init-serviceList.js" defer="defer"></script>
<style type="text/css">
.STYLE3 {
	font-size: 12px
}
...
<body>
<div class="wrap">
	<h1>当前位置：会议与资源&nbsp;&gt;&nbsp;<span class="position_current"> 会议模板</span></h1>
