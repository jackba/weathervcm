...
public class PageHolder {
	...
	public String getPageInfo(){
		...
		sb.append("<tr>");
		sb.append("<input type=\"hidden\" name=\"currPage\" value=\""+currentPage+"\"/>");
		...
		sb.append("<td height='40' colspan='6'><div id='page'>[&nbsp;&nbsp;<a href='#' onClick='toPage(1)'>首页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#' onClick='toPage("+((currentPage-1)<1?1:(currentPage-1))+")>上一页</a>&nbsp;&nbsp;|&nbsp;&nbsp;");
		for(int i=1;i<=totalPage;i++){
			 if(i==currentPage){
				 sb.append("<strong>"+i+"</strong>");
			 }else{
				 sb.append("<a href='#' onClick='toPage("+i+")'>"+i+"</a> ");
				 
			 }
		}
		sb.append("&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#' onClick='toPage("+((currentPage+1)>totalPage?totalPage:(currentPage+1))+")+'>下一页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#' onClick='toPage("+totalPage+")'>末页</a> &nbsp;&nbsp;]</div> </td>");
		sb.append("</tr> ");
